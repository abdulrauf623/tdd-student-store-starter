...
![GIF WALKTHROUGH]https://recordit.co/w2UfQc5bZO
...
**App.jsx** // all steps here complete
...
**Navbar.jsx** // all steps here complete
...
**Logo.jsx** // all steps here complete
...
**Home.jsx** // all steps here complete
...
**Hero.jsx**. // all steps here complete
...
**ProductGrid.jsx** // all steps here complete
...
**ProductDetail.jsx**. // all steps here complete
...
**ProductView.jsx** // all steps here complete
...
**ProductCard.jsx** // all steps here complete
...
**Sidebar.jsx** // all steps here complete
...
**ShoppingCart.jsx**. // all steps here complete
...
**CheckoutForm.jsx** // all steps here complete
...
**Server** - Create an Express server // all steps here complete
...
**Models** - The API should use a `Store` model that handles the following // all steps here complete
...
React itself in general was a little confusing before the first lab. The labs for expresss back end was very useful in creating my get and post requests and for error handling

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have created the order list for users to see their previous orders

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

This project specifically helped me understand how to pass props down through multiple components and how to write post and get codes
...
Both TAs were extremely helpful and Moe. Joram, Aloye and Yaw were also very useful resources.
